...
const API_KEY = "AdultJigsaw_internal_9f3c7b2a6a1d4e8f9c0b";
...
/**
 * GET https://adultjigsaw.com/_functions/ping
 */
...
/**
 * GET https://adultjigsaw.com/_functions/products?limit=10
 */
...
export async function get_blogText(request) {
  try {
    ...
    const candidates = [
      `https://adultjigsaw.com/adult-jigsaw-puzzle-blog/${slug}`,
      `https://adultjigsaw.com/post/${slug}`,
      `https://adultjigsaw.com/blog/${slug}`,
      `https://adultjigsaw.com/${slug}` // fallback
    ];
