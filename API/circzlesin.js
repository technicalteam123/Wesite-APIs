...
const API_KEY = "CircZles_IND_9f3c7b2a6a1d4e8f9c0b";
...
/**
 * GET https://circzles.in/_functions/ping
 */
...
/**
 * GET https://circzles.in/_functions/products?limit=10
 */
...
export async function get_blogText(request) {
  try {
    ...
    const candidates = [
      `https://circzles.in/blog/${slug}`,
      `https://circzles.in/post/${slug}`,
      `https://circzles.in/blog/${slug}`,
      `https://circzles.in/${slug}` // fallback
    ];
