...
const API_KEY = "wooden_Puzzles_9f3c7b2a6a1d4e8f9c0b";
...
/**
 * GET https://woodenpuzzle.in/_functions/ping
 */
...
/**
 * GET https://woodenpuzzles.in/_functions/products?limit=10
 */
...
export async function get_blogText(request) {
  try {
    ...
    const candidates = [
      `https://woodenpuzzles.in/wooden-puzzle-articles-india/${slug}`,
      `https://woodenpuzzles.in/post/${slug}`,
      `https://woodenpuzzles.in/blog/${slug}`,
      `https://woodenpuzzles.in/${slug}` // fallback
    ];
