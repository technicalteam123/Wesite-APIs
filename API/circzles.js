...
const API_KEY = "CircZles_internal_9f3c7b2a6a1d4e8f9c0b";
...
/**
 * GET https://circzles.com/_functions/ping
 */
...
/**
 * GET https://circzles.com/_functions/products?limit=10
 */
...
export async function get_blogText(request) {
  try {
    ...
    const candidates = [
      `https://circzles.com/circzles-wooden-jigsaw-puzzles-blogs/${slug}`,
      `https://circzles.com/post/${slug}`,
      `https://circzles.com/blog/${slug}`,
      `https://circzles.com/${slug}` // fallback
    ];
